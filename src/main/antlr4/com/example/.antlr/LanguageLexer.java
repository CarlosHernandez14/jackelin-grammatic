...
public class LanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FIN_STMT", "FIN_PROG", "TIPO", "OP_ASIG", "OP_SUMA", "OP_REST", "OP_MULT", 
			"OP_DIV", "OP_REL", "PAREIZ", "PAREDR", "LLAVEIZQ", "LLAVEDER", "SI", 
			"SINO", "PARA", "IMPRIMIR", "NUM", "CADENA", "BOOL", "ID", "LINE_COMMENT", 
			"WS"
		};
	}
